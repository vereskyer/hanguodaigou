...
const props = defineProps({
    ...
    products: {
        type: Object, // 或者更精确地定义为 Array 或 Pagination 对象
        required: true,
    },
    imageUrl: String,
});
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:col-start-2 lg:justify-center">
                        <img src="https://images.pexels.com/photos/1337380/pexels-photo-1337380.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                            alt="Logo" class="h-8" />
                    </div>
                            ...
                            <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                                <div v-for="product in props.products.data" :key="product.id"
                                    ...
                                    <div class="h-56 w-full">
                                        <a href="#">
                                            <img class="mx-auto h-full dark:hidden" v-if="getProductImage(product)"
                                                :src="getProductImage(product)" alt="" />
                                            <img class="mx-auto hidden h-full dark:block"
                                                v-if="getProductImage(product)" :src="getProductImage(product)"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="pt-6">
                                ...
                                <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                                    ...
                                    <div class="px-4 md:px-5">
                                        ...
                                        <div class="space-y-4" id="advanced-filters" role="tabpanel"
                                            ...
                                            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                                                <div class="grid grid-cols-2 gap-3">
                                                    ...
                                                    <div class="col-span-2 flex items-center justify-between space-x-2">
                                                        ...
                                                        <div class="shrink-0 text-sm font-medium dark:text-gray-300">to
                                                        </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="space-y-2">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <label for="gray"
                                                                class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-300">
                                                                <div class="mr-2 h-3.5 w-3.5 rounded-full bg-gray-400">
                                                                </div>
                                                                Gray
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <label for="green"
                                                                class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-300">
                                                                <div class="mr-2 h-3.5 w-3.5 rounded-full bg-green-400">
                                                                </div>
                                                                Green
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <label for="pink"
                                                                class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-300">
                                                                <div class="mr-2 h-3.5 w-3.5 rounded-full bg-pink-400">
                                                                </div>
                                                                Pink
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <label for="red"
                                                                class="ml-2 flex items-center text-sm font-medium text-gray-900 dark:text-gray-300">
                                                                <div class="mr-2 h-3.5 w-3.5 rounded-full bg-red-500">
                                                                </div>
                                                                Red
                                                            </label>
                                                        </div>
                                            ...
                                            <div>
                                                <h6 class="mb-2 text-sm font-medium text-black dark:text-white">Delivery
                                                    type</h6>
                                                ...
                                                <ul class="grid grid-cols-2 gap-4">
                                                    ...
                                                    <li>
                                                        ...
                                                        <label for="delivery-australia"
                                                            class="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-600 peer-checked:border-primary-600 peer-checked:text-primary-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-primary-500 md:p-5">
                                                            <div class="block">
                                                                <div class="w-full text-lg font-semibold">Australia
                                                                </div>
