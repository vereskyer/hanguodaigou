                ...
                <ul class="space-y-2">
                    ...
                    <li v-if="hasRole('admin')">
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Users 管理</span>
                    ...
                    <li v-if="hasRole('admin')">
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Products管理</span>
                            <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                            <li>
                                <NavLink :href="route('tenant.products.index')"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    我的商品列表
                                </NavLink>
                            </li>
                            <li>
                                <NavLink :href="route('tenant.products.central')"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    中央商品庫
                                </NavLink>
                            </li>
