                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div
                        ...
                        <div
                            ...
                            <NavLink :href="route('users.create')" type="button"
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr v-for="user in users" class="border-b dark:border-gray-700">
                                    <th scope="row"
                                    ...
                                    <!-- <td v-for="role in user.roles" class="px-4 py-3">
                                        {{ role.name }}
                                    </td> -->

                                    <td class="px-4 py-3">
                                        <div v-if="user.roles && user.roles.length" class="flex gap-1">
